...
reddit_sentiment_path = os.path.join(base_dir, "coca_cola_sentiment_reddit.csv")
tweets_sentiment_path = os.path.join(base_dir, "coca_cola_sentiment_tweets.csv")
...
optimized_output_path = os.path.join(base_dir, "coca_cola_sentiment_data.csv")
