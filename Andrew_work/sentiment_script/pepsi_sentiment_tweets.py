...
def analyze_sentiments(data):
    ...
    data['sentiment_score_textblob'] = data['text'].apply(lambda x: TextBlob(x).sentiment.polarity)
    data['sentiment_score_vader'] = data['text'].apply(lambda x: sia.polarity_scores(x)['compound'])
...
output_path = Path(__file__).resolve().parent / "pepsi_sentiment_tweets.csv"
df.to_csv(output_path, index=False)
print("Final analyzed data saved to: pepsi_sentiment_tweets.csv")
